...
> 生产环境应该由运维等专业人员进行修改配置，此小节主要用于了解Linux的相关参数
...
HeadContext也是DefaultChannelPipeline的内部类。如下（这里不深究源码）：
...
![image-20220707131615932](https://mypic-12138.oss-cn-beijing.aliyuncs.com/blog/picgo/image-20220707131615932.png)
