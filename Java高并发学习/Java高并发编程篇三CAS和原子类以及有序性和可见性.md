...
>
> **本文并不是对原书的照搬，而是对原书学习理解后重新编写代码并记录整理笔记和自己的理解，本文不会发博客，只会存在本人的Github的[Code_Career项目](https://github.com/Loserfromlazy/Code_Career)中t
>
...
假设线程A执行update()方法，线程B执行plus()方法，因为代码1和2没有数据依赖关系，所以1和2可能被重排序，它们在重排序后的次序为：先执行2在执行2.
